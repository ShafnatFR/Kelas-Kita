                ...
                <div class="row g-0">
                    ...
                    <div class="col-12 col-md-3 d-flex flex-column align-items-center pt-3">
                        ...
                        <div class="d-grid gap-2 w-75 mb-4">
                            ...
                            <a href="setting-notifikasi.html" class="btn btn-danger active">Notifikasi</a>
                    ...
                    <div class="col-12 col-md-9 p-3">
                        <div class="card-body">
                            <div class="text-center">
                                <h3 class="mb-4"><strong>Notifikasi</strong></h3>
                            </div>
                                <div class="form-check form-switch form-check-reverse d-flex">
                                    <div class="col-12 col-md-9 text-start mt-0">
                                        <label class="form-check-label" for="flexSwitchCheckReverse"><strong>Notifikasi Postingan Baru</strong></label>
                                        <p>Menampilkan notifikasi ketika ada postingan
                                            baru di forum atau diskusi yang diikuti.</p>
                                    </div>
                                        <div class="col-md-3">
                                            <input class="form-check-input mt-5" type="checkbox" id="flexSwitchCheckReverse">
                                        </div>
                                </div>

                                <div class="form-check form-switch form-check-reverse d-flex">
                                    <div class="col-12 col-md-9 text-start mt-0">
                                        <label class="form-check-label" for="flexSwitchCheckReverse"><strong>Komentar Baru</strong></label>
                                ...
                                <div class="form-check form-switch form-check-reverse d-flex">
                                    <div class="col-12 col-md-9 text-start mt-0">
                                        <label class="form-check-label" for="flexSwitchCheckReverse"><strong>Balasan ke Komentar</strong></label>
                                        <p>Memberikan notifikasi ketika seseorang membalas
                                            komentar pengguna.</p>
                                    </div>
                                        <div class="col-md-3">
                                            <input class="form-check-input mt-5" type="checkbox" id="flexSwitchCheckReverse">
