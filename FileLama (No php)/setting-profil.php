                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="text" class="form-control" id="namaBelakang" placeholder="">
                                </div>
                                <div class="mb-0">
                                    <label for="kelas" class="form-label">Kelas</label>
                                    <input type="text" class="form-control" id="kelas" placeholder="D3SI 48-04">
                                </div>
                                <div class="mb-0">
                                    <label for="prodi" class="form-label">Program Studi</label>
                                    <input type="text" class="form-control" id="prodi" placeholder="D3 Sistem Informasi">
                                </div>
                                <div class="mb-0">
                                    <label for="fakultas" class="form-label">Fakultas</label>
                                    <input type="text" class="form-control" id="fakultas" placeholder="Fakultas Ilmu Terapan">
                                </div>
                                <div class="mb-0">
                                    <label for="universitas" class="form-label">Universitas</label>
                                    <input type="text" class="form-control" id="universitas" placeholder="Telkom University">
                                </div>
                                <div class="mb-0">
                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi" rows="3" placeholder="Deskripsi diri"></textarea>
                                </div>
