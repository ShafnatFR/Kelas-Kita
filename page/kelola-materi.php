...
<head>
    ...
    <style>
        ...
        /* Wrapper untuk konten utama agar tidak tertimpa sidebar */
        .main-content {
        ...
        .card-body::before {
            ...
            width: 100px;
            height: 100px;
            background: linear-gradient(45deg, transparent 50%, rgba(0,123,255,0.08) 50%);
        ...
        /* Perbaikan untuk tampilan mobile/responsif */
        @media (max-width: 992px) {
            /* Sembunyikan sidebar di layar kecil. Anda perlu tombol untuk memunculkannya nanti. */
            .sidebar {
                display: none; 
            }
            .main-content {
                margin-left: 0; /* Hapus margin saat sidebar hilang */
                padding: 1rem;
            }
        }
    </style>
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <?php if ($view_level === 'kelas'): ?>
                ...
                <div class="row">
                    <?php
                    // SEMUA LOGIKA PHP ANDA DIKEMBALIKAN
                        ...
                        while ($sub_materi = $sub_materi_result->fetch_assoc()) {
                            ...
                            <div class="col-lg-6 col-md-12 mb-4">
                                <div class="card card-hover h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <span class="badge bg-info text-dark badge-count">Urutan <?= htmlspecialchars($sub_materi['urutan']) ?></span>
