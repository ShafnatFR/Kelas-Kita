                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0"><?= htmlspecialchars($stats['total_users']) ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0"><?= htmlspecialchars($stats['total_kelas']) ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0">Rp<?= number_format($transaksi['total_transaksi'], 0, ',', '.') ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0"><?= htmlspecialchars($stats['total_materi']) ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php if (count($tb_kelasData) > 0): ?>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group" role="group">
                                                            <a href="edit_user.php?id=<?= $kelas['id_kelas'] ?>" 
                                                               class="btn btn-sm btn-outline-primary" 
                                                               title="Edit User">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>
                                                            <a href="delete_user.php?id=<?= $kelas['id_kelas'] ?>" 
                                                               class="btn btn-sm btn-outline-danger" 
                                                               title="Hapus User"
                                                               onclick="return confirm('Apakah Anda yakin ingin menghapus user <?= htmlspecialchars($kelas['username']) ?>?\n\nTindakan ini tidak dapat dibatalkan!')">
                                                                <i class="fas fa-trash"></i> Hapus
                                                            </a>
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="mt-3 d-flex justify-content-between align-items-center">
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle me-1"></i>
                                            Total: <?= count($tb_userData) ?> kelas terdaftar
                                        </small>
                                        <div>
                                            <button class="btn btn-sm btn-outline-success" onclick="location.reload()">
                                                <i class="fas fa-sync-alt me-1"></i>Refresh
