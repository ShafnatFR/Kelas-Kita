        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 d-flex flex-column align-items-center pt-3">
                ...
                <div class="d-grid gap-2 w-75 mb-4">
                    ...
                    <a href="admin-kelolaMateri.php" class="btn btn-outline-primary active">Kelola Materi</a>
                        ...
                        <div class="card bg-success text-white">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-0">Total Report Materi</h5>
                        ...
                        <div class="card bg-primary text-white">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-0">Total Seluruh Materi</h5>
                        ...
                        <div class="card bg-warning text-white">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-0">Total Materi Diterima</h5>
                        ...
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-0">Total Materi Dinonatifkan</h5>
